...
# Here are the input and output data paths (Note: you can override wav_path in preprocess1.py)
wav_path = '/path/to/wav_files/'
data_path = 'data/'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'sova_raw'
tts_model_id = 'sova_tts'
...
tts_dropout = 0.5
language = 'ru'
tts_cleaner_name = 'russian_cleaners'
use_phonemes = True
